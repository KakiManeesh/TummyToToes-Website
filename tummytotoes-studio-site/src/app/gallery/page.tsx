...
type Category = "Newborn" | "Maternity" | "Kids" | "Events" | "Fashion" | "Wedding";

const categories: Category[] = ["Newborn", "Maternity", "Kids", "Events", "Fashion", "Wedding"];
...
const GalleryContent = () => {
  const [active, setActive] = useState<Category>("Newborn");
  const [displayed, setDisplayed] = useState<Category>("Newborn");
